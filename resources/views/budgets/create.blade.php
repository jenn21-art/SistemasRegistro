...
@section('title','Presupuesto/crear'){{--Titulo de la pagina,puede aparecer en la cabecera del layout o en el navegador --}}
                  ...
                  <div class="card-header bg-white border-0">
                      <div class="row align-items-center">
                           <div class="col-8">
                                ...
                                <h3 class="mb-0"><i class="fas fa-plus-circle"></i> Registrar Presupuesto</h3>
                          </div>
