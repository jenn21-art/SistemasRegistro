...
@section('title','Mantenimiento Correctivo/crear'){{--Titulo de la pagina,puede aparecer en la cabecera del layout o en el navegador --}}
                  ...
                  <div class="card-header bg-white border-0">
                      <div class="row align-items-center">
                           <div class="col-8">
                                ...
                                <h3 class="mb-0"><i class="fas fa-plus-circle"></i> Registrar Mantenimiento Correctivo</h3>
                          </div>
                          ...
                          <div class="card-body container-fluid">
                               ...
                               <form action="{{ route('corrective_maintenances.store') }}" method="POST">
                                   @csrf 
